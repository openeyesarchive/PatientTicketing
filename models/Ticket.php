...
class Ticket extends \BaseActiveRecordVersioned
{
	...
	public function relations()
	{
		return array(
			...
			'initial_queue_assignment' => array(self::HAS_ONE, 'OEModule\PatientTicketing\models\TicketQueueAssignment', 'ticket_id', 'order' => 'assignment_date'),
			'current_queue_assignment' => array(self::HAS_ONE, 'OEModule\PatientTicketing\models\TicketQueueAssignment', 'ticket_id', 'order' => 'assignment_date desc'),
