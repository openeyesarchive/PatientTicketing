...
class Ticket extends \BaseActiveRecordVersioned
{
	...
	public function relations()
	{
		return array(
			...
			'initial_queue' => array(self::HAS_ONE, 'OEModule\PatientTicketing\models\Queue', 'queue_id', 'through' => 'intiial_queue_assignment'),
			'current_queue' => array(self::HAS_ONE, 'OEModule\PatientTicketing\models\Queue', 'queue_id', 'through' => 'current_queue_assignment'),
		);
	}
